...
if __name__ == "__main__":
    ...
    parser.add_argument('--org', default='softteco',
                        help='name of organization you would check the packages')
    ...
    r = s.get(f'https://api.github.com/orgs/{args.org}/packages/'
    ...
    for index, v in enumerate(versions):
        ...
        if len(metadata['tags']) > 0 and index>args.number-1:
            if args.dry_run:
                ...
                r = s.delete(f'https://api.github.com/orgs/{args.org}/packages/'
